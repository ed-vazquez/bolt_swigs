defmodule Bolt.Swigs.Internals.PackStream.EncoderV1Test do
  use ExUnit.Case, async: true

  alias Bolt.Swigs.Internals.PackStream.EncoderV1

  defmodule TestStruct do
    defstruct foo: "bar"
  end

  doctest Bolt.Swigs.Internals.PackStream.EncoderV1
