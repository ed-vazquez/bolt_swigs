defmodule Bolt.Swigs.Internals.PackStream.Message.EncoderV1Test do
  use ExUnit.Case, async: true

  doctest Bolt.Swigs.Internals.PackStream.Message.EncoderV1

  alias Bolt.Swigs.Internals.PackStream.Message.EncoderV1
