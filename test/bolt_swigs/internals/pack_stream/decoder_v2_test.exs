defmodule Bolt.Swigs.Internals.PackStream.DecoderV2Test do
  use ExUnit.Case, async: true
  alias Bolt.Swigs.Internals.PackStream.DecoderV2
  ...
  describe "Decode temporal data:" do
    ...
    test "Datetime with zone id" do
      dt =
        Bolt.Swigs.TypesHelper.datetime_with_micro(~N[1998-03-18 06:25:12.123456], "Europe/Paris")
