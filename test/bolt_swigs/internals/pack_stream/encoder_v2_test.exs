defmodule Bolt.Swigs.Internals.PackStream.EncoderV2Test do
  use ExUnit.Case, async: true

  alias Bolt.Swigs.Internals.PackStream.EncoderV2
  alias Bolt.Swigs.Types.{TimeWithTZOffset, DateTimeWithTZOffset, Duration, Point}
  alias Bolt.Swigs.TypesHelper

  doctest Bolt.Swigs.Internals.PackStream.EncoderV2
