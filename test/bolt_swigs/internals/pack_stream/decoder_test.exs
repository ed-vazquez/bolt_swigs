defmodule Bolt.Swigs.Internals.PackStream.DecoderTest do
  use ExUnit.Case, async: true

  alias Bolt.Swigs.Internals.PackStream.Decoder
  alias Bolt.Swigs.Internals.PackStreamError
  alias Bolt.Swigs.Internals.BoltVersionHelper
  alias Bolt.Swigs.Types
  ...
  describe "Decodes Bolt >= 2 specific types" do
    ...
    |> Enum.each(fn bolt_version ->
      ...
      test "Datetime with timezone id (bolt_version: #{bolt_version})" do
        dt =
          Bolt.Swigs.TypesHelper.datetime_with_micro(
