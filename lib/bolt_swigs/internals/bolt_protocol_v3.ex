defmodule Bolt.Swigs.Internals.BoltProtocolV3 do
  ...
  ## Examples
      ...
      iex> Bolt.Swigs.Internals.BoltProtocolV3.hello(:gen_tcp, port, 3, {}, [])
      {:ok, info}

      iex> Bolt.Swigs.Internals.BoltProtocolV3.hello(:gen_tcp, port, 3, {"username", "password"}, [])
      {:ok, info}
  """
  ...
  ## Examples
      ...
      iex> Bolt.Swigs.Internals.BoltProtocolV3.goodbye(:gen_tcp, port, 3)
      :ok
  ...
  @spec begin(atom(), port(), integer(), Bolt.Swigs.Metadata.t() | map(), Keyword.t()) ::
          {:ok, any()} | Bolt.Swigs.Internals.Error.t()
  ...
  ## Example
      ...
      :ok
  """
  @spec rollback(atom(), port(), integer(), Keyword.t()) :: :ok | Bolt.Swigs.Internals.Error.t()
