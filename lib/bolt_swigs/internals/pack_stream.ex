defmodule Bolt.Swigs.Internals.PackStream do
  @moduledoc false
  ...
  # stream, using the Bolt.Swigs.Internals.PackStream.Encoder protocol.
  ...
  ## Examples
      ...
      iex> Bolt.Swigs.Internals.PackStream.encode "hello world"
      <<0x8B, 0x68, 0x65, 0x6C, 0x6C, 0x6F, 0x20, 0x77, 0x6F, 0x72, 0x6C, 0x64>>
  """
  @spec encode(any(), integer()) :: Bolt.Swigs.Internals.PackStream.value() | <<_::16, _::_*8>>
  def encode(item, bolt_version) do
    Bolt.Swigs.Internals.PackStream.Encoder.encode(item, bolt_version)
  end
  ...
  ## Example
      ...
      iex> Bolt.Swigs.Internals.PackStream.decode(<<0xC3>>)
      [true]
  """
  @spec decode(binary(), integer()) :: list()
  def decode(data, bolt_version) do
    Bolt.Swigs.Internals.PackStream.Decoder.decode(data, bolt_version)
  end
end
