defmodule Bolt.Swigs.Internals.BoltProtocolHelper do
  @moduledoc false

  alias Bolt.Swigs.Internals.PackStream.Message
  ...
  """
  @spec send_message(atom(), port(), integer(), Bolt.Swigs.Internals.PackStream.Message.raw()) ::
          :ok | {:error, any()}
  ...
  * `:failure`
  ...
  @spec receive_data(atom(), port(), integer(), Keyword.t(), list()) ::
          {atom(), Bolt.Swigs.Internals.PackStream.value()}
          | {:error, any()}
  ...
  @spec treat_simple_message(
          Bolt.Swigs.Internals.Message.out_signature(),
          atom(),
          port(),
          integer(),
          Keyword.t()
