defmodule Bolt.Swigs.Internals.Error do
  @moduledoc false
  ...
  @doc false
  # Produce a Bolt.Swigs.Internals.Error depending on the context.
  @spec exception(any(), nil | port(), atom()) :: Bolt.Swigs.Internals.Error.t()
  def exception(%{"message" => message, "code" => code}, pid, function) do
    %Bolt.Swigs.Internals.Error{
      message: message,
      code: code,
  ...
  def exception(
        {:failure, %Bolt.Swigs.Internals.Error{message: _message, code: _code} = err},
        _pid,
        _function
      ) do
    err
  ...
  def exception(%Bolt.Swigs.Internals.Error{} = err, _pid, _function), do: err
