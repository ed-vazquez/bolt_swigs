defmodule Bolt.Swigs.Internals.PackStream.EncoderV2 do
  @moduledoc false
  use Bolt.Swigs.Internals.PackStream.Markers
  alias Bolt.Swigs.Internals.PackStream.EncoderHelper
  alias Bolt.Swigs.Types.{TimeWithTZOffset, DateTimeWithTZOffset, Duration, Point}
  ...
  ## Example
      ...
      iex> :erlang.iolist_to_binary(Bolt.Swigs.Internals.PackStream.EncoderV2.encode_local_time(~T[06:54:32.453], 2))
      <<0xB1, 0x74, 0xCB, 0x0, 0x0, 0x16, 0x9F, 0x11, 0xB9, 0xCB, 0x40>>
  """
  @spec encode_local_time(Time.t(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
  ...
  ## Example
      ...
      iex> time_with_tz = Bolt.Swigs.Types.TimeWithTZOffset.create(~T[06:54:32.453], 3600)
      iex> :erlang.iolist_to_binary(Bolt.Swigs.Internals.PackStream.EncoderV2.encode_time_with_tz(time_with_tz, 2))
  ...
  ## Example
      ...
      iex> :erlang.iolist_to_binary(Bolt.Swigs.Internals.PackStream.EncoderV2.encode_date(~D[2019-04-23], 2))
      <<0xB1, 0x44, 0xC9, 0x46, 0x59>>

  """
  @spec encode_date(Date.t(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
  ...
  ## Example
      ...
      iex> :erlang.iolist_to_binary(Bolt.Swigs.Internals.PackStream.EncoderV2.encode_local_datetime(~N[2019-04-23 13:45:52.678], 2))
      <<0xB2, 0x64, 0xCA, 0x5C, 0xBF, 0x17, 0x10, 0xCA, 0x28, 0x69, 0x75, 0x80>>

  """
  @spec encode_local_datetime(Calendar.naive_datetime(), integer()) ::
          Bolt.Swigs.Internals.PackStream.value()
  ...
  ## Example
      ...
      iex> d = Bolt.Swigs.TypesHelper.datetime_with_micro(~N[2013-11-12 07:32:02.003],
      ...> "Europe/Berlin")
      #DateTime<2013-11-12 07:32:02.003+01:00 CET Europe/Berlin>
      iex> :erlang.iolist_to_binary(Bolt.Swigs.Internals.PackStream.EncoderV2.encode_datetime_with_tz_id(d, 2))
  ...
  ## Example
      ...
      iex> d = Bolt.Swigs.Types.DateTimeWithTZOffset.create(~N[2013-11-12 07:32:02.003], 7200)
      %Bolt.Swigs.Types.DateTimeWithTZOffset{
              naive_datetime: ~N[2013-11-12 07:32:02.003],
              timezone_offset: 7200
            }
      iex> :erlang.iolist_to_binary(Bolt.Swigs.Internals.PackStream.EncoderV2.encode_datetime_with_tz_offset(d, 2))
  ...
  ## Example
      ...
      iex(60)> d = %Bolt.Swigs.Types.Duration{
      ...(60)>   years: 3,
      ...(60)>   months: 1,
      ...(60)>   weeks: 7,
      ...(60)>   days: 4,
      ...
      iex> :erlang.iolist_to_binary(Bolt.Swigs.Internals.PackStream.EncoderV2.encode_duration(d, 2))
      <<0xB4, 0x45, 0x25, 0x35, 0xCA, 0x0, 0x0, 0xB7, 0x5D, 0xC9, 0x2, 0x2A>>
  """
  @spec encode_duration(Duration.t(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
  ...
  ## Example
      ...
      iex> p = Bolt.Swigs.Types.Point.create(:wgs_84, 65.43, 12.54)
      ...
      iex> :erlang.iolist_to_binary(Bolt.Swigs.Internals.PackStream.EncoderV2.encode_point(p, 2))
  ...
  ## Example
      ...
      iex> p = Bolt.Swigs.Types.Point.create(:wgs_84, 45.0003, 40.3245, 23.1)
      %Bolt.Swigs.Types.Point{
              crs: "wgs-84-3d",
              height: 23.1,
              latitude: 40.3245,
  ...
  """
  @spec encode_point(Point.t(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
