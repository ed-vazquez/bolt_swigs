defmodule Bolt.Swigs.Internals.PackStream.DecoderImplV2 do
  ...
  defmacro __using__(_options) do
    quote do
      ...
      @last_version Bolt.Swigs.Internals.BoltVersionHelper.last()
      ...
      def decode(
        ...
        dt = Bolt.Swigs.TypesHelper.datetime_with_micro(naive_dt, zone_id)
        [dt | rest]
      end
