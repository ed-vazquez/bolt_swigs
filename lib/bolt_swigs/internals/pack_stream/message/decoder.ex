defmodule Bolt.Swigs.Internals.PackStream.Message.Decoder do
  @moduledoc false
  ...
  @spec decode(Bolt.Swigs.Internals.PackStream.Message.encoded(), integer()) ::
  ...
  @spec build_response(
          Bolt.Swigs.Internals.PackStream.Message.in_signature(),
          any(),
          integer(),
          integer()
        ) ::
  ...
  defp build_response(message_type, data, nb_entries, bolt_version) do
    Bolt.Swigs.Internals.Logger.log_message(:server, message_type, data, :hex)

    response =
      case Bolt.Swigs.Internals.PackStream.decode(data, bolt_version) do
    ...
    Bolt.Swigs.Internals.Logger.log_message(:server, message_type, response)
