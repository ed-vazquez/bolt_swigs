defmodule Bolt.Swigs.Internals.PackStream.EncoderHelper do
  @moduledoc false
  alias Bolt.Swigs.Internals.BoltVersionHelper
  alias Bolt.Swigs.Internals.PackStreamError

  use Bolt.Swigs.Internals.PackStream.V1
  use Bolt.Swigs.Internals.PackStream.V2
  use Bolt.Swigs.Internals.PackStream.Utils
