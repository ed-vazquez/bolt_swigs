defmodule Bolt.Swigs.Internals.PackStream.EncoderV1 do
  @moduledoc false
  ...
  ## Example
      ...
      iex> alias Bolt.Swigs.Internals.PackStream.EncoderV1
  ...
  """
  @spec encode_atom(atom(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
  ...
  """
  @spec encode_string(String.t(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
  ...
  """
  @spec encode_integer(integer(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
  ...
  """
  @spec encode_float(float(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
  ...
  """
  @spec encode_list(list(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
  ...
  """
  @spec encode_map(map(), integer()) :: Bolt.Swigs.Internals.PackStream.value()
  ...
  """
  @spec encode_struct({integer(), list()}, integer()) :: Bolt.Swigs.Internals.PackStream.value()
