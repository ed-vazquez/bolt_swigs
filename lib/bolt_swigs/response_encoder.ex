defmodule Bolt.Swigs.ResponseEncoder do
  @moduledoc """
  This module provides functions to encode a query result or data containing Bolt.Swigs.Types
  into various format.
  ...
  - for step 1: `Bolt.Swigs.ResponseEncoder.Json`
  - for step 2 (depending of your preferred library):
  - `Bolt.Swigs.ResponseEncoder.Json.Jason`
  - `Bolt.Swigs.ResponseEncoder.Json.Poison`

  ## Example

      iex> data = %{"t1" => %Bolt.Swigs.Types.Node{
      ...>     id: 69,
      ...>     labels: ["Test"],
      ...>     properties: %{
      ...>       "created" => %Bolt.Swigs.Types.DateTimeWithTZOffset{
      ...
      ...>   }
      ...> }
      iex> Bolt.Swigs.ResponseEncoder.encode(data, :json)
      {:ok, ~S|{"t1":{"id":69,"labels":["Test"],"properties":{"created":"2016-05-24T13:26:08.543+02:00","uuid":12345}}}|}

      iex> Bolt.Swigs.ResponseEncoder.encode("\\xFF", :json)
  ...
  defp jsonable_response(response) do
    response
    |> Bolt.Swigs.ResponseEncoder.Json.encode()
  end
end
