defprotocol Bolt.Swigs.ResponseEncoder.Json do
  @moduledoc """
  ...
  ```
  defimpl Bolt.Swigs.ResponseEncoder.Json, for: Bolt.Swigs.Types.Node do
    def encode(node) do
  ...
  It is also possible to provide implementation that returns structs or updated Bolt.Swigs.Types,
  the use of a final `Bolt.Swigs.ResponseEncoder.Json.encode()` will ensure that these values will
...
alias Bolt.Swigs.{Types, ResponseEncoder}
