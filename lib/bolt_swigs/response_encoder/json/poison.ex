if Code.ensure_loaded?(Poison) do
  defmodule Bolt.Swigs.ResponseEncoder.Json.Poison do
    @moduledoc """
    ...
    {:ok, res} = Bolt.Swigs.query(conn, "MATCH (t:TestNode) RETURN t")
    Poison.encode!(res)
    ```
    ...
    #### Note:
    In order to benefit from Bolt.Swigs.ResponseEncoder implementation, use
    `Bolt.Swigs.ResponseEncoder.Json.encode` and pass the result to the Poison
    encoding functions.
    """
    alias Bolt.Swigs.Types
    alias Bolt.Swigs.ResponseEncoder.Json
