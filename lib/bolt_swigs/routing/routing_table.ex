defmodule Bolt.Swigs.Routing.RoutingTable do
  @moduledoc ~S"""
  ...
  latest version of Bolt.Swigs, you could use this query:

      Bolt.Swigs.query!(Bolt.Swigs.conn, "call dbms.cluster.routing.getRoutingTable($props)", %{props: %{}})
